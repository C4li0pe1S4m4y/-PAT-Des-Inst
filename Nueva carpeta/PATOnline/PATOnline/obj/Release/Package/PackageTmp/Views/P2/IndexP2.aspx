...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="row">
          ...
          <ContentTemplate>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                ...
                <input runat="server" id="TxtColCuatro" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
              ...
              <div class="col-md-2">
                ...
                <input runat="server" id="TxtColFinanza" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="0,000,000.00" maxlength="12" autofocus />
              </div>
              <div class="col-md-2">
    ...
    <div class="row">
      ...
      <div class="row" style="height: 350px; width: 104%; overflow-y: auto;">
        <div class="modal-header gradiant">
