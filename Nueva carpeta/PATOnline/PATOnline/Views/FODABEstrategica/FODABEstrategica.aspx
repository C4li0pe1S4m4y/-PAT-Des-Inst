  ...
  <div class="row">
    <h1>
      ...
      <% if (boton.BotonCrear(this.Session["Usuario"].ToString()) == true)
          { %>
      <a href="CreateFODABEstrategica.aspx" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a>
      <% } %> 
    </h1>
  </div>
  ...
  <div id="demo" class="row collapse in panel panel-default">
    ...
    <div class="panel-body">
      <asp:GridView ID="gvListadoInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo_PageIndexChanging"
        CssClass="footable" HeaderStyle-ForeColor="Black" PagerStyle-ForeColor="Black" ForeColor="Black" PageSize="6" OnRowCommand="gvListadoInfo_RowCommand" Font-Size="Large">
        <Columns>
    ...
    <div class="panel-body">
      <asp:GridView ID="gvListadoInfo2" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo2_PageIndexChanging"
        CssClass="footable" HeaderStyle-ForeColor="Black" PagerStyle-ForeColor="Black" ForeColor="Black" PageSize="6" BorderStyle="Groove" OnRowCommand="gvListadoInfo2_RowCommand" Font-Size="Large">
        <Columns>
          <asp:BoundField DataField="numero" HeaderText="NO.">
            <ItemStyle Width="1%" />
          </asp:BoundField>
