      ...
      <div class="row" style="text-align: center; align-content: center;">
        <div class="col-md-6">
          <h3>
            ...
            <a href="CrearPuesto.aspx" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a></h3>
        </div>
        <div class="col-md-6">
          <h3>
            <asp:Label runat="server" ID="lblBrecha"></asp:Label>
            <a href="CrearBrecha.aspx" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a></h3>
        </div>
      </div>
      <% } %>
    </div>
