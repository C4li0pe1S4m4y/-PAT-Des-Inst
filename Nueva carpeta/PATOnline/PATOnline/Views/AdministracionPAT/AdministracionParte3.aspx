                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                      ...
                      <input runat="server" id="TxtFormatoC" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre del formato" maxlength="40" autofocus required />
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                      ...
                      <input runat="server" id="TxtActividad" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre de la actividad" maxlength="40" autofocus required />
