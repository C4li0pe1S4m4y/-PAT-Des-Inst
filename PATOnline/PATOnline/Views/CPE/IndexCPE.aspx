<%@ Page Title="CPE" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IndexCPE.aspx.cs" Inherits="PATOnline.Views.CPE.indexCPE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">CPE</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearCPENew">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">CPE</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoCPE" CausesValidation="false" OnClick="nuevoCPE_Click">
      ...
      <section class="content">
        <div class="container-fluid">
          <asp:UpdatePanel runat="server" ID="updateCrearCPE">
            <ContentTemplate>
          <div class="row">
            <div class="col-md-6">
              <div class="card card-outline card-info" runat="server" id="mostrarCrearCPE">
                <div class="card-header">
                  <h3 class="card-title"><span class="info-box-number">CREAR NUEVO CPE</span></h3>
                ...
                <div class="card-body pad" style="display: block;">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearCPE" runat="server" ControlToValidate="dropCrearFormato"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearCPE" runat="server" ControlToValidate="txtCrearEneroAbril"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearCPE" runat="server" ControlToValidate="txtCrearMayoAgosto"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearCPE" runat="server" ControlToValidate="txtCrearSeptiembreDiciembre"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearCPE" runat="server" ControlToValidate="txtCrearPresupuesto"
                ...
                <div class="card-footer">
                  <asp:LinkButton runat="server" ID="cancelCrearCPE" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearCPE_Click">
                <span class="fa fa-close"></span>
                  </asp:LinkButton>
                  <asp:LinkButton runat="server" ValidationGroup="validarCrearCPE" ID="crearCPE" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearCPE_Click">
            ...
            <div class="col-md-6">
              <div class="card card-outline card-warning" runat="server" id="mostrarEditCPE">
                <div class="card-header">
                  <h3 class="card-title"><span class="info-box-number">MODIFICAR CPE</span></h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                      <i class="fa fa-minus"></i>
                    </button>
                ...
                <div class="card-body pad" style="display: block;">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditCPE" runat="server" ControlToValidate="dropEditFormato"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un Formato" />
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditCPE" runat="server" ControlToValidate="txtEditEneroAbril"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditCPE" runat="server" ControlToValidate="txtEditMayoAgosto"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditCPE" runat="server" ControlToValidate="txtEditSeptiembreDiciembre"
                        CssClass="text-danger" ErrorMessage="* El es obligatorio ingresar un valor o 0" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditCPE" runat="server" ControlToValidate="txtEditPresupuesto"
                        CssClass="text-danger" ErrorMessage="* El Presupuesto es obligatorio" />
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <asp:LinkButton runat="server" ID="cancelEditCPE" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditCPE_Click">
                <span class="fa fa-close"></span>
                  </asp:LinkButton>
                  <asp:LinkButton runat="server" ValidationGroup="validarEditCPE" ID="editCPE" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editCPE_Click">
                <span class="fa fa-save"></span>
                  </asp:LinkButton>
                </div>
              </div>
              ...
              <div class="card-body" style="overflow-x: auto;">
                ...
                <div class="row" style="text-align: center;">
                  <div class="col-md-12" style="background-color: darkturquoise; color: black;">
                    <h4>
                      <asp:Label runat="server" ForeColor="Black" Text="PLANIFICACIÓN ESTRATÉGICA Y GESTIÓN ADMINISTRATIVA DE LA ALTA DIRECCIÓN"></asp:Label></h4>
                  </div>
