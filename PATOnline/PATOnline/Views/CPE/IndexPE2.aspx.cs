...
namespace PATOnline.Views.CPE
{
    public partial class IndexPE2 : System.Web.UI.Page
    {
        ...
        protected void SaveIngreso_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ultimo_codigo.ExisteCodigoPE2(TxtCodigo.Text, federacion, ano) != true)
                {
        ...
        protected void gvP3_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if((ultimo_codigo.PE2Total(federacion, ano) > 0) && (ultimo_codigo.PE2Total(federacion, ano) < ultimo_codigo.PresupuestoPE2(federacion, ano)))
                {
                    e.Row.Cells[1].ForeColor = System.Drawing.Color.Orange;
                }
                else if(ultimo_codigo.PE2Total(federacion,ano) == ultimo_codigo.PresupuestoPE2(federacion, ano))
                {
