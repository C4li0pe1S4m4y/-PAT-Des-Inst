...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">PE2</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearPE2New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">PE2</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoPE2" CausesValidation="false" OnClick="nuevoPE2_Click">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearPE2">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">CREAR NUEVO PE2</span></h3>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearPE2" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearPE2_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarCrearPE1" ID="crearPE2" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearPE2_Click">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditPE2">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">MODIFICAR PE2</span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fa fa-minus"></i>
                </button>
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                <div class="col-md-2">
                  <asp:Label runat="server" ID="idEditPE2"></asp:Label>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditPE2" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditPE2_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarEditPE2" ID="editPE2" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editPE2_Click">
                <span class="fa fa-save"></span>
              </asp:LinkButton>
            </div>
          </div>
                    ...
                    <div class="col-md-12">
                      <table class="table table-bordered">
                        <tr>
                          ...
                          <th style="width: 18%; text-align: center; font-size: 11px;" rowspan="3"><b>NOMBRE DE LA ACTIVIDAD</b></th>
                        ...
                        <tr>
                          <th style="width: 4%; text-align: center; font-size: 11px;"><b>DÍA</b></th>
                          <th style="width: 5%; text-align: center; font-size: 11px;"><b>MES</b></th>
                          <th style="width: 5%; text-align: center; font-size: 11px;"><b>DÍA</b></th>
                          <th style="width: 4%; text-align: center; font-size: 11px;"><b>MES</b></th>
                          <th style="width: 11%; text-align: center; font-size: 11px;"><b>DEPARTAMENTO</b></th>
                          <th style="width: 9%; text-align: center; font-size: 11px;"><b>PAÍS</b></th>
                    ...
                    <div class="col-md-12">
                      <asp:GridView ID="gridFADN" runat="server" AutoGenerateColumns="False" DataKeyNames="numero" OnRowDataBound="gridFADN_RowDataBound"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="codigo" ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="actividad" ItemStyle-Width="20%" ItemStyle-Font-Size="Small" />
                          ...
                          <asp:BoundField DataField="departamento" ItemStyle-Width="12%" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="Small" />
                          <asp:BoundField DataField="pais" ItemStyle-Width="9%" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="Small" />
                          <asp:BoundField DataField="lugar" ItemStyle-Width="14%" ItemStyle-Font-Size="Small" />
                            ...
                            <ItemTemplate>
                              <asp:LinkButton ID="btEditar" runat="server" type="button" class="btn btn-block btn-warning btn-sm" CausesValidation="false"
                                CommandName="Editar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                                  <ItemStyle HorizontalAlign="Center"/><span class="fa fa-edit"></span>
                              </asp:LinkButton>
                              <asp:LinkButton ID="btVer" runat="server" type="button" class="btn btn-block btn-success btn-sm" CausesValidation="false"
                                CommandName="Mostrar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                                  <ItemStyle HorizontalAlign="Center"/><span class="fa fa-eye"></span>
                              </asp:LinkButton>
                              <asp:LinkButton ID="btEliminar" runat="server" type="button" class="btn btn-block btn-danger btn-sm"
                                CommandName="Eliminar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                            <ItemStyle HorizontalAlign="Center"/><span class="fa fa-trash-o"></span>
                              </asp:LinkButton>
                              <asp:LinkButton ID="btObservacion" runat="server" type="button" class="btn btn-block btn-warning btn-sm" CausesValidation="false"
                                CommandName="Observacion" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                                  <ItemStyle HorizontalAlign="Center"/><span class="fa fa-comment"></span>
                              </asp:LinkButton>
                              <asp:LinkButton ID="btAprobar" runat="server" type="button" class="btn btn-block btn-success btn-sm" CausesValidation="false"
                                CommandName="Aprobar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                                  <ItemStyle HorizontalAlign="Center"/><span class="fa fa-thumbs-up"></span>
                              </asp:LinkButton>
                              <asp:LinkButton ID="btEnviar" runat="server" type="button" class="btn btn-block btn-info btn-sm" CausesValidation="false"
                                CommandName="Enviar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                                  <ItemStyle HorizontalAlign="Center"/><span class="fa fa-send"></span>
                              </asp:LinkButton>
                            </ItemTemplate>
                          </asp:TemplateField>
                        </Columns>
                          ...
                          <asp:TemplateField>
                            ...
                            <ItemTemplate>
                              <p style="text-align: right; color: black;">
                                <b>
                                  <asp:Label runat="server" Text="TOTALES"></asp:Label></b>
                              </p>
                            </ItemTemplate>
                          </asp:TemplateField>
                          <asp:TemplateField>
