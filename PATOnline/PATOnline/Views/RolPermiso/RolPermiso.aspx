      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Rol y Permisos</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearRol">
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                <div class="col-md-12">
                  <asp:Label runat="server" CssClass="control-label"><span style="color:red">*</span> ROL</asp:Label>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearRol" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearRol_Click">
        ...
        <div class="col-md-6">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditarRol">
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                <div class="col-md-12">
                  <asp:Label runat="server" AssociatedControlID="TxtmodificarRol" CssClass="control-label"><span style="color:red">*</span> ROL</asp:Label>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditRol" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditRol_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearPermiso">
            ...
            <div class="card-body">
              <asp:UpdatePanel runat="server" ID="selectMenu">
                <ContentTemplate>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <asp:Label runat="server" AssociatedControlID="checkboxOneInput" CssClass="control-label"><span style="color:red">*</span> PANTALLA</asp:Label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <asp:Label runat="server" AssociatedControlID="checkboxTwoInput" CssClass="control-label"><span style="color:red">*</span> BOTÓN</asp:Label>
                  <div class="checkbox checkbox-primary" style="border: groove;">
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearPermiso" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearPermiso_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
        ...
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditarPermiso">
            ...
            <div class="card-body pad">
              <div class="row">
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="DropEditarPermisoRol" CssClass="control-label"><span style="color:red">*</span> ROL</asp:Label>
                ...
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="DropEditarPermisoMenu" CssClass="control-label"><span style="color:red">*</span> MENÚ</asp:Label>
              ...
              <asp:UpdatePanel runat="server" ID="pintarCheckBoxBton">
                <ContentTemplate>
                  <div class="row">
                    <div class="col-md-12">
                      <asp:Label runat="server" AssociatedControlID="checkboxEditarPermisoBoton" CssClass="control-label"><span style="color:red">*</span> BOTÓN</asp:Label>
                      <div class="checkbox checkbox-primary" style="border: groove;">
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditPermiso" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditPermiso_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              ...
              <div class="row">
                <div class="col-md-12">
                  <asp:GridView ID="gvListadoInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo_PageIndexChanging" PageSize="1"
                    ...
                    <Columns>
                      <asp:BoundField DataField="rol" HeaderText="NOMBRE DEL ROL" HeaderStyle-Font-Size="Medium">
                        <ItemStyle Width="70%" />
                      </asp:BoundField>
