...
namespace PATOnline.Views.C2
{
    public partial class IndexC2_3 : System.Web.UI.Page
    {
        ...
        protected void SaveIngreso_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ultimo_codigo.ExisteCodigoC2_3(TxtCodigo.Text, federacion, ano) != true)
                {
        ...
        protected void gvP3_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (double.Parse((e.Row.FindControl("lblPresupuesto") as Label).Text) == ultimo_codigo.PresupuestoC2_3(federacion, ano))
                {
