<%@ Page Title="2. POTENCIAL DEPORTIVO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IndexC2.aspx.cs" Inherits="PATOnline.Views.C2.IndexC2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">C2</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearC2New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">C2</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoC2" CausesValidation="false" OnClick="nuevoC2_Click">
      ...
      <section class="content">
        <div class="container-fluid">
        <asp:UpdatePanel runat="server" ID="updateCrearC2">
        <ContentTemplate>
          <div class="row">
            <div class="col-md-6">
              <div class="card card-outline card-info" runat="server" id="mostrarCrearC2">
                <div class="card-header">
                  <h3 class="card-title"><span class="info-box-number">CREAR NUEVO C2</span></h3>
                ...
                <div class="card-body pad" style="display: block;">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC2" runat="server" ControlToValidate="dropCrearFormato"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC2" runat="server" ControlToValidate="txtCrearEneroAbril"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC2" runat="server" ControlToValidate="txtCrearMayoAgosto"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC2" runat="server" ControlToValidate="txtCrearSeptiembreDiciembre"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC2" runat="server" ControlToValidate="txtCrearPresupuesto"
                ...
                <div class="card-footer">
                  <asp:LinkButton runat="server" ID="cancelCrearC2" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearC2_Click">
                <span class="fa fa-close"></span>
                  </asp:LinkButton>
                  <asp:LinkButton runat="server" ValidationGroup="validarCrearC2" ID="crearC2" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearC2_Click">
            ...
            <div class="col-md-6">
              <div class="card card-outline card-warning" runat="server" id="mostrarEditC2">
                <div class="card-header">
                  <h3 class="card-title"><span class="info-box-number">MODIFICAR C2</span></h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                      <i class="fa fa-minus"></i>
                    </button>
                ...
                <div class="card-body pad" style="display: block;">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC2" runat="server" ControlToValidate="dropEditFormato"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un Formato" />
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC2" runat="server" ControlToValidate="txtEditEneroAbril"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC2" runat="server" ControlToValidate="txtEditMayoAgosto"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC2" runat="server" ControlToValidate="txtEditSeptiembreDiciembre"
                        CssClass="text-danger" ErrorMessage="* El es obligatorio ingresar un valor o 0" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC2" runat="server" ControlToValidate="txtEditPresupuesto"
                        CssClass="text-danger" ErrorMessage="* El Presupuesto es obligatorio" />
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <asp:LinkButton runat="server" ID="cancelEditC2" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditC2_Click">
                <span class="fa fa-close"></span>
                  </asp:LinkButton>
                  <asp:LinkButton runat="server" ValidationGroup="validarEditC2" ID="editC2" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editC2_Click">
                <span class="fa fa-save"></span>
                  </asp:LinkButton>
                </div>
              </div>
                ...
                <div class="card-body" style="overflow-x: auto;">
                  ...
                  <div class="row" style="text-align: center;">
                    <div class="col-md-12" style="background-color: darkturquoise; color: black;">
                      <h4>
                        <asp:Label runat="server" ForeColor="Black" Text="2. POTENCIAL DEPORTIVO"></asp:Label></h4>
                    </div>
