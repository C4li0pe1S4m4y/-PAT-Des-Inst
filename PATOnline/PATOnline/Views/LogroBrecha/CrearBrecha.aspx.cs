...
namespace PATOnline.Views.LogroBrecha
{
    public partial class CrearBrecha : System.Web.UI.Page
    {
        ...
        protected void SaveBrecha_Click(object sender, EventArgs e)
        {
            ...
            modelo_brecha.punteo = Convert.ToDouble(TxtPuntosBrecha.Value);
            modelo_brecha.puntos = Convert.ToDouble(TxtPuntosObtenidos.Value);
            modelo_brecha.comparacion = Convert.ToDouble(TxtComparacion.Value);
            modelo_brecha.observacion = TxtObservacionBrecha.Value;
        ...
        protected void CancelBrecha_Click(object sender, EventArgs e)
        {
            ...
            TxtPuntosBrecha.Value = null;
            TxtPuntosObtenidos.Value = null;
            TxtComparacion.Value = null;
            TxtObservacionBrecha.Value = null;
