          ...
          <asp:GridView ID="gvP3" runat="server" AllowPaging="false" AutoGenerateColumns="False" DataKeyNames="idnumero2" BorderWidth="2" BorderColor="Black"
            ...
            <Columns>
              ...
              <asp:TemplateField>
                ...
                <ItemTemplate>
                  <span>Q
                        <asp:Label ID="lbl3" runat="server" Text='<%# Eval("total1") %>'></asp:Label></span>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField>
                <ItemStyle Width="111px" Font-Size="Smaller" />
                <ItemTemplate>
                  <span>Q
                        <asp:Label ID="lbl4" runat="server" Text='<%# Eval("total2") %>'></asp:Label></span>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField>
                <ItemStyle Width="109px" Font-Size="Smaller" />
                <ItemTemplate>
                  <span>Q
                        <asp:Label ID="lbl5" runat="server" Text='<%# Eval("total3") %>'></asp:Label></span>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField>
                <ItemStyle Width="109px" Font-Size="Smaller" />
                <ItemTemplate>
                  <span>Q
                        <asp:Label ID="lbl6" runat="server" Text='<%# Eval("total4") %>'></asp:Label></span>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField>
