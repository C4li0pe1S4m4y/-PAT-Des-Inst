...
namespace PATOnline.Views.DirigentesFADN
{
    public partial class CrearPersonal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lbl.Text = "CREAR PERSONAL TENICO ADMINISTRATIVO";
                lblInfo.Text = "MOSTRAR INFORMACIÓN DEL PERSONAL TENICO ADMINISTRATIVO";
                lblSub.Text = "PERSONAL TENICO ADMINISTRATIVO";
        ...
        public void CargarGrid1()
        {
            ...
            if (all.DirigenciaRead(4, federacion, ano).Rows.Count != 0)
            {
                gvListadoInfo.DataSource = all.DirigenciaRead(4, federacion, ano);
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>window.alert('Error al agregar registro el Personal','Crear Personal')" +
