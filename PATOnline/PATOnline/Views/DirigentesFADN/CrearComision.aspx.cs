...
{
    public partial class CrearComision : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lbl.Text = "CREAR COMISIÓN TECNICO DEPORTIVA";
                lblInfo.Text = "MOSTRAR INFORMACIÓN DE COMISIÓN TECNICO DEPORTIVA";
                lblSub.Text = "COMISIÓN TECNICO DEPORTIVA";
        ...
        public void CargarGrid1()
        {
            ...
            if (all.DirigenciaRead(3, federacion, ano).Rows.Count != 0)
            {
                gvListadoInfo.DataSource = all.DirigenciaRead(3, federacion, ano);
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>window.alert('Error al agregar registro a la Comision','Crear Comision')" +
