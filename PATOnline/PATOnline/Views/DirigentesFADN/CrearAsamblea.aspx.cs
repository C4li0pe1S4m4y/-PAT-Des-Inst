...
{
    public partial class CrearAsamblea : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lbl.Text = "CREAR ASAMBLEA DE FADN";
                lblInfo.Text = "MOSTRAR INFORMACIÓN DE ASAMBLEA DE FADN";
                lblSub.Text = "ASAMBLEA DE FADN";
        ...
        public void CargarGrid1()
        {
            ...
            if (all.DirigenciaRead(1,federacion,ano).Rows.Count != 0)
            {
                gvListadoInfo.DataSource = all.DirigenciaRead(1, federacion, ano);
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>window.alert('Error al agregar registro a la Asamblea','Crear Asamblea')" +
