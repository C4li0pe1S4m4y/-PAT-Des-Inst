...
namespace PATOnline.Views.C3
{
    public partial class IndexC3 : System.Web.UI.Page
    {
        ...
        protected void CargarGrid()
        {
            ...
            crearC3New.Visible = false;
            mostrarCrearC3.Visible = false;
            mostrarEditC3.Visible = false;
            crearObservacionSinRechazo.Visible = false;
            crearObservacionRechazo.Visible = false;
            crearObservacionSinRechazo.Visible = false;
            mostrarObservacion.Visible = false;

            crearC3.Visible = false;
            editC3.Visible = false;
            btPDF.Visible = false;
            ...
            switch (Session["Rol"].ToString())
            {
                case "Usuario Interno de FADN":
                    gridFADN.DataSource = pat.C3Read(Session["Federacion"].ToString(), year, 0);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3TotalRead(Session["Federacion"].ToString(), year, 0);
                    gridFADNTotal.DataBind();

                    DataTable mostrar5 = new DataTable();
                    mostrar5 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3");
                    ...
                    for (int j = 0; j < mostrar5.Rows.Count; j++)
                    {
                        switch (mostrar5.Rows[j][0].ToString())
                        {
                            ...
                            case "Crear":
                                crearC3New.Visible = true;
                                nuevoC3.Visible = true;
                                break;
                        }
                    }
                    break;
                ...
                case "Usuario CE de FADN":
                    gridFADN.DataSource = pat.C3Read(Session["Federacion"].ToString(), year, 3);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3TotalRead(Session["Federacion"].ToString(), year, 3);
                    gridFADNTotal.DataBind();

                    DataTable mostrar4 = new DataTable();
                    mostrar4 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3");
                ...
                case "Técnico Acompañamiento":
                    ...
                    gridFADN.DataSource = pat.C3Read(Session["FederacionAsignada"].ToString(), year, 6);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3TotalRead(Session["FederacionAsignada"].ToString(), year, 6);
                    gridFADNTotal.DataBind();

                    DataTable mostrar2 = new DataTable();
                    mostrar2 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3");
                ...
                case "Técnico Evaluación":
                    ...
                    gridFADN.DataSource = pat.C3Read(Session["FederacionAsignada"].ToString(), year, 9);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3TotalRead(Session["FederacionAsignada"].ToString(), year, 9);
                    gridFADNTotal.DataBind();

                    DataTable mostrar3 = new DataTable();
                    mostrar3 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3");
        ...
        protected void nuevoC3_Click(object sender, EventArgs e)
        {
            drop.Drop_FormatoC(dropCrearFormato, 4);
            mostrarCrearC3.Visible = true;
        }

        protected void dropCrearFormato_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (pat.ExisteC3(int.Parse(dropCrearFormato.SelectedValue), Session["Federacion"].ToString(), year) == true)
            {
        ...
        protected void cancelCrearC3_Click(object sender, EventArgs e)
        {
            mostrarCrearC3.Visible = false;
        }

        protected void crearC3_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        protected void cancelEditC3_Click(object sender, EventArgs e)
        {
            mostrarEditC3.Visible = false;
        }

        protected void editC3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pat.C3Update(modelo, int.Parse(idEditCPE.Text), 0);
                CargarGrid();
                mostrarEditC3.Visible = false;
        ...
        protected void guardarObservacionRechazo_Click(object sender, EventArgs e)
        {
            try
            {
                obseracion.id9 = int.Parse(idIntroObservacionRechazo.Text);
                ...
                pat.C3Update(modelo, int.Parse(idIntroObservacionRechazo.Text), 13);
                crearObservacionRechazo.Visible = false;
                CargarGrid();
        ...
        protected void btcrearObservacionRechazo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["Rol"].ToString() == "Usuario CE de FADN" || Session["Rol"].ToString() == "Técnico Evaluación")
                {
                    ...
                    pat.C3Update(modelo, int.Parse(idIntroObservacionRechazo.Text), 2);
                    crearObservacionRechazo.Visible = false;
                    CargarGrid();
                }
        ...
        protected void btObservacionSinRechazo_Click(object sender, EventArgs e)
        {
            try
            {
                obseracion.id9 = int.Parse(idIntroObservacionSinRechazo.Text);
                obseracion.observacion = txtCrearObservacionSinRechazo.Value;
                obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                obs.observacionCreateAcompaniamiento(obseracion);
                pat.C3Update(modelo, int.Parse(idIntroObservacionSinRechazo.Text), 9);
                crearObservacionSinRechazo.Visible = false;
                CargarGrid();
                ScriptManager.RegisterStartupScript(this, typeof(string), "Mensaje", "swal('¡Completo!', 'La informaicón fue ingresada', 'success');", true);
        ...
        protected void gridFADN_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            mostra = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3");
                ...
                if (int.Parse(e.Row.Cells[0].Text) > 0)
                {
                    for (int j = 0; j < mostra.Rows.Count; j++)
                    {
                        switch (mostra.Rows[j][0].ToString())
                        {
                            ...
                            case "Editar":
                                if (pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 2)
                                {
                            ...
                            case "Ver":
                                if (obs.ObservacionCEFADNExiste(int.Parse(e.Row.Cells[0].Text), 10) == true
                                            || obs.ObservacionAcompaniamientoExiste(int.Parse(e.Row.Cells[0].Text), 10) == true
                                            || obs.ObservacionEvaluadorExiste(int.Parse(e.Row.Cells[0].Text), 10) == true)
                                {
                            ...
                            case "Eliminar":
                                if (pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 1 || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 2)
                                {
                            ...
                            case "Enviar":
                                if (pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 1
                                        || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 2
                                        || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 3
                                        || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 6
                                        || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 9)
                                {
                            ...
                            case "Aprobar":
                                if (pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 3 || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 9)
                                {
                            ...
                            case "Observación":
                                if (pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 3
                                        || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 6
                                        || pat.C3Estado(int.Parse(e.Row.Cells[0].Text)) == 9)
                                {
        ...
        protected void gridFADN_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editar")
            {
                ...
                {
                    case "Usuario Interno de FADN":
                        drop.Drop_FormatoC(dropEditFormato, 4);
                        data = pat.C3Seleccionar(int.Parse(row.Cells[0].Text));
            ...
            {
                listObservacionesFADN.DataSource = obs.observacionMostrarFADN(int.Parse(row.Cells[0].Text), 10);
                listObservacionesAcompaniamiento.DataSource = obs.observacionMostrarAcompaniamiento(int.Parse(row.Cells[0].Text), 10);
                listObservacionesEvaluacion.DataSource = obs.observacionMostrarEvaluador(int.Parse(row.Cells[0].Text), 10);
            ...
            if (e.CommandName == "Aprobar")
            {
                ...
                {
                    case "Usuario CE de FADN":
                        obseracion.id9 = int.Parse(row.Cells[0].Text);
                        obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                        obs.observacionCreateFADN(obseracion);
                        pat.C3Update(modelo, int.Parse(row.Cells[0].Text), 6);
                        break;
                    ...
                    case "Técnico Evaluación":
                        ...
                        obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                        obs.observacionCreateEvaluador(obseracion);
                        pat.C3Update(modelo, int.Parse(row.Cells[0].Text), 13);
                        break;
                }
            ...
            if (e.CommandName == "Enviar")
            {
                ...
                {
                    case "Usuario Interno de FADN":
                        pat.C3Update(modelo, int.Parse(row.Cells[0].Text), 3);
                        break;
                    ...
                    case "Técnico Acompañamiento":
                        ...
                        obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                        obs.observacionCreateAcompaniamiento(obseracion);
                        pat.C3Update(modelo, int.Parse(row.Cells[0].Text), 9);
                        break;
                }
            ...
            {
                pat.C3Update(modelo, int.Parse(row.Cells[0].Text), 12);
                CargarGrid();
            }
            gridFADN.Columns[0].Visible = false;
        }
