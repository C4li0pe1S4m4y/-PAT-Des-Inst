...
namespace PATOnline.Views.C3
{
    public partial class IndexC3_2 : System.Web.UI.Page
    {
        ...
        protected void CargarGrid()
        {
            ...
            crearC32New.Visible = false;
            mostrarCrearC32.Visible = false;
            mostrarEditC32.Visible = false;
            crearObservacionSinRechazo.Visible = false;
            crearObservacionRechazo.Visible = false;
            crearObservacionSinRechazo.Visible = false;
            mostrarObservacion.Visible = false;

            crearC32.Visible = false;
            editC32.Visible = false;
            btPDF.Visible = false;
            ...
            switch (Session["Rol"].ToString())
            {
                case "Usuario Interno de FADN":
                    gridFADN.DataSource = pat.C3_2Read(Session["Federacion"].ToString(), year, 0);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3_2TotalRead(Session["Federacion"].ToString(), year, 0);
                    gridFADNTotal.DataBind();

                    DataTable mostrar5 = new DataTable();
                    mostrar5 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3.2: SJDN");
                    ...
                    for (int j = 0; j < mostrar5.Rows.Count; j++)
                    {
                        switch (mostrar5.Rows[j][0].ToString())
                        {
                            ...
                            case "Crear":
                                crearC32New.Visible = true;
                                nuevoC32.Visible = true;
                                break;
                        }
                    }
                    break;
                ...
                case "Usuario CE de FADN":
                    gridFADN.DataSource = pat.C3_2Read(Session["Federacion"].ToString(), year, 3);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3_2TotalRead(Session["Federacion"].ToString(), year, 3);
                    gridFADNTotal.DataBind();

                    DataTable mostrar4 = new DataTable();
                    mostrar4 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3.2: SJDN");
                ...
                case "Técnico Acompañamiento":
                    ...
                    gridFADN.DataSource = pat.C3_2Read(Session["FederacionAsignada"].ToString(), year, 6);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3_2TotalRead(Session["FederacionAsignada"].ToString(), year, 6);
                    gridFADNTotal.DataBind();

                    DataTable mostrar2 = new DataTable();
                    mostrar2 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3.2: SJDN");
                ...
                case "Técnico Evaluación":
                    ...
                    gridFADN.DataSource = pat.C3_2Read(Session["FederacionAsignada"].ToString(), year, 9);
                    gridFADN.DataBind();
                    gridFADNTotal.DataSource = pat.C3_2TotalRead(Session["FederacionAsignada"].ToString(), year, 9);
                    gridFADNTotal.DataBind();

                    DataTable mostrar3 = new DataTable();
                    mostrar3 = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3.2: SJDN");
        ...
        {
            int codigo = pat.C3_2Codigo(fadn, ano);
            if (codigo > 99)
            {
                nuevo_codigo = "-C3_2-" + Convert.ToString(codigo + 1);
            }
            else if (codigo > 9 && codigo < 100)
            {
                nuevo_codigo = "-C3_2-0" + Convert.ToString(codigo + 1);
            }
            else
            {
                nuevo_codigo = "-C3_2-00" + Convert.ToString(codigo + 1);
            }
            return nuevo_codigo;
        }

        protected void nuevoC32_Click(object sender, EventArgs e)
        {
            txtCrearCodigo.Enabled = false;
            txtCrearCodigo.Text = year + generarCodigo(Session["Federacion"].ToString(), year);
            drop.Drop_ActividadPAT(dropCrearActividad, 21);
            drop.Drop_Categoria(dropCrearCategoria, 11);
            ...
            mostrarCrearC32.Visible = true;
        }

        protected void cancelCrearC32_Click(object sender, EventArgs e)
        {
            mostrarCrearC32.Visible = false;
        }

        protected void crearC32_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                modelo.masculino = int.Parse(txtCrearMasculino.Value);
                modelo.femenino = int.Parse(txtCrearFemenino.Value);
                modelo.total = modelo.masculino + modelo.femenino;
        ...
        protected void cancelEditC32_Click(object sender, EventArgs e)
        {
            mostrarEditC32.Visible = false;
        }

        protected void editC32_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                modelo.masculino = int.Parse(txtEditMasculino.Value);
                modelo.femenino = int.Parse(txtEditFemenino.Value);
                modelo.total = modelo.masculino + modelo.femenino;
                ...
                pat.C3_2Update(modelo, int.Parse(idEdit.Text), 0);
                CargarGrid();
                mostrarCrearC32.Visible = false;
                txtEditCodigo.Text = null;
                txtEditPresupuesto.Value = null;
                txtEditEdades.Value = null;
                txtEditMasculino.Value = null;
                txtEditFemenino.Value = null;
        ...
        protected void guardarObservacionRechazo_Click(object sender, EventArgs e)
        {
            try
            {
                obseracion.id11 = int.Parse(idIntroObservacionRechazo.Text);
                ...
                pat.C3_2Update(modelo, int.Parse(idIntroObservacionRechazo.Text), 13);
                crearObservacionRechazo.Visible = false;
                CargarGrid();
        ...
        protected void btcrearObservacionRechazo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["Rol"].ToString() == "Usuario CE de FADN" || Session["Rol"].ToString() == "Técnico Evaluación")
                {
                    ...
                    pat.C3_2Update(modelo, int.Parse(idIntroObservacionRechazo.Text), 2);
                    crearObservacionRechazo.Visible = false;
                    CargarGrid();
                }
        ...
        protected void btObservacionSinRechazo_Click(object sender, EventArgs e)
        {
            try
            {
                obseracion.id11 = int.Parse(idIntroObservacionSinRechazo.Text);
                obseracion.observacion = txtCrearObservacionSinRechazo.Value;
                obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                obs.observacionCreateAcompaniamiento(obseracion);
                pat.C3_2Update(modelo, int.Parse(idIntroObservacionSinRechazo.Text), 9);
                crearObservacionSinRechazo.Visible = false;
                CargarGrid();
                ScriptManager.RegisterStartupScript(this, typeof(string), "Mensaje", "swal('¡Completo!', 'La informaicón fue ingresada', 'success');", true);
        ...
        protected void gridFADN_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            mostra = boton.BotonReadUsuario(Session["Usuario"].ToString(), "C3.2: SJDN");
                ...
                if (int.Parse(e.Row.Cells[0].Text) > 0)
                {
                    for (int j = 0; j < mostra.Rows.Count; j++)
                    {
                        switch (mostra.Rows[j][0].ToString())
                        {
                            ...
                            case "Editar":
                                if (pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 2)
                                {
                            ...
                            case "Ver":
                                if (obs.ObservacionCEFADNExiste(int.Parse(e.Row.Cells[0].Text), 12) == true
                                            || obs.ObservacionAcompaniamientoExiste(int.Parse(e.Row.Cells[0].Text), 12) == true
                                            || obs.ObservacionEvaluadorExiste(int.Parse(e.Row.Cells[0].Text), 12) == true)
                                {
                            ...
                            case "Eliminar":
                                if (pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 1 || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 2)
                                {
                            ...
                            case "Enviar":
                                if (pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 1
                                        || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 2
                                        || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 3
                                        || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 6
                                        || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 9)
                                {
                            ...
                            case "Aprobar":
                                if (pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 3 || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 9)
                                {
                            ...
                            case "Observación":
                                if (pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 3
                                        || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 6
                                        || pat.C3_2Estado(int.Parse(e.Row.Cells[0].Text)) == 9)
                                {
        ...
        protected void gridFADN_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editar")
            {
                ...
                {
                    case "Usuario Interno de FADN":
                        drop.Drop_ActividadPAT(dropEditActividad, 21);
                        drop.Drop_Categoria(dropEditCategoria, 11);
                        ...
                        data = pat.C3_2Seleccionar(int.Parse(row.Cells[0].Text));
                        ...
                        for (int i = 0; i < data.Rows.Count; i++)
                        {
                            ...
                            txtEditEdades.Value = data.Rows[i][5].ToString();
                            txtEditMasculino.Value = data.Rows[i][6].ToString();
                            txtEditFemenino.Value = data.Rows[i][7].ToString();
                            txtEditRegistro.Value = data.Rows[i][8].ToString();
                            dropEditDiaInicio.SelectedValue = data.Rows[i][9].ToString();
                            dropEditMesInicio.SelectedItem.Value = data.Rows[i][10].ToString();
                            dropEditDiaFin.SelectedValue = data.Rows[i][11].ToString();
                            dropEditMesFin.SelectedItem.Value = data.Rows[i][12].ToString();
                            dropEditDepartamento.SelectedValue = data.Rows[i][13].ToString();
                            txtEditLugar.Value = data.Rows[i][14].ToString();
                        }
                        idEdit.Visible = false;
                        txtEditCodigo.Enabled = false;
                        mostrarEditC32.Visible = true;
                        break;
            ...
            {
                listObservacionesFADN.DataSource = obs.observacionMostrarFADN(int.Parse(row.Cells[0].Text), 12);
                listObservacionesAcompaniamiento.DataSource = obs.observacionMostrarAcompaniamiento(int.Parse(row.Cells[0].Text), 12);
                listObservacionesEvaluacion.DataSource = obs.observacionMostrarEvaluador(int.Parse(row.Cells[0].Text), 12);
            ...
            if (e.CommandName == "Aprobar")
            {
                ...
                {
                    case "Usuario CE de FADN":
                        obseracion.id11 = int.Parse(row.Cells[0].Text);
                        obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                        obs.observacionCreateFADN(obseracion);
                        pat.C3_2Update(modelo, int.Parse(row.Cells[0].Text), 6);
                        break;
                    ...
                    case "Técnico Evaluación":
                        ...
                        obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                        obs.observacionCreateEvaluador(obseracion);
                        pat.C3_2Update(modelo, int.Parse(row.Cells[0].Text), 13);
                        break;
                }
            ...
            if (e.CommandName == "Enviar")
            {
                ...
                {
                    case "Usuario Interno de FADN":
                        pat.C3_2Update(modelo, int.Parse(row.Cells[0].Text), 3);
                        break;
                    ...
                    case "Técnico Acompañamiento":
                        ...
                        obseracion.usuario = id.idUsuario(Convert.ToString(Session["Usuario"]));
                        obs.observacionCreateAcompaniamiento(obseracion);
                        pat.C3_2Update(modelo, int.Parse(row.Cells[0].Text), 9);
                        break;
                }
            ...
            {
                pat.C3_2Update(modelo, int.Parse(row.Cells[0].Text), 12);
                CargarGrid();
            }
            gridFADN.Columns[0].Visible = false;
        }
        ...
        protected void gridFADNTotal_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if ((e.Row.FindControl("lblPresupuesto") as Label).Text != "")
                {
                    ...
                    {
                        case "Usuario Interno de FADN":
                            if (double.Parse((e.Row.FindControl("lblPresupuesto") as Label).Text) == pat.C3_2Presupuesto(Session["Federacion"].ToString(), year, 0))
                            {
                        ...
                        case "Usuario CE de FADN":
                            if (double.Parse((e.Row.FindControl("lblPresupuesto") as Label).Text) == pat.C3_2Presupuesto(Session["Federacion"].ToString(), year, 3))
                            {
                                e.Row.Cells[1].ForeColor = System.Drawing.Color.Green;
                            }
                            else
                        ...
                        case "Técnico Acompañamiento":
                            if (this.Session["FederacionAsignada"] == null) { Response.Redirect("~/DashboardFADN.aspx"); }
                            if (double.Parse((e.Row.FindControl("lblPresupuesto") as Label).Text) == pat.C3_2Presupuesto(Session["FederacionAsignada"].ToString(), year, 6))
                            {
                                e.Row.Cells[1].ForeColor = System.Drawing.Color.Green;
                            }
                            else
                        ...
                        case "Técnico Evaluación":
                            if (this.Session["FederacionAsignada"] == null) { Response.Redirect("~/DashboardFADN.aspx"); }
                            if (double.Parse((e.Row.FindControl("lblPresupuesto") as Label).Text) == pat.C3_2Presupuesto(Session["FederacionAsignada"].ToString(), year, 9))
                            {
                                e.Row.Cells[1].ForeColor = System.Drawing.Color.Green;
                            }
                            else
