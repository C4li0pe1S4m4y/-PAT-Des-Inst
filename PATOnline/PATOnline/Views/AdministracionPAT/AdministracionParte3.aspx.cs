...
namespace PATOnline.Views.AdministracionPAT
{
    public partial class AdministracionParte3 : System.Web.UI.Page
    {
        ...
        {
            if (verficar.ExisteFormatoCPAT(TxtFormatoC.Text) == true)
            {
        ...
        {
            if (verficar_categoria.CategoriaFormatoSearch(TxtCategoria.Text, int.Parse(DropIDPadreCategoria.SelectedValue)) == true)
            {
        ...
        {
            if (verificar_actidiad.ExisteActividadPAT(int.Parse(DropActividad.SelectedValue), TxtFormatoC.Text) == true)
            {
            ...
            {
                modelo_actividad.nombre = TxtActividad.Text;
