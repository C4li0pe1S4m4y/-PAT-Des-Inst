          ...
          <div class="card card-success">
            ...
            <div class="card-body" style="overflow-x: auto;">
              <asp:GridView ID="gvFormatoTitulo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="idformato_c" OnRowDataBound="gvFormatoTitulo_RowDataBound"
                CssClass="table table-bordered table-responsive dataTable" HeaderStyle-BackColor="#e8f2fc" OnPageIndexChanging="gvFormatoTitulo_PageIndexChanging" OnRowCommand="gvFormatoTitulo_RowCommand">
                <Columns>
                  <asp:BoundField DataField="idformato_c" HeaderStyle-Font-Size="Medium" />
                  <asp:BoundField DataField="nombre" HeaderStyle-Font-Size="Medium" HeaderText="FORMATOS C">
                    <ItemStyle Width="100%" />
                  </asp:BoundField>
          ...
          <div class="card card-success">
            ...
            <div class="card-body" style="overflow-x: auto;">
              <asp:GridView ID="gvCategoriaTitulo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnRowDataBound="gvCategoriaTitulo_RowDataBound"
                CssClass="table table-bordered table-responsive dataTable" HeaderStyle-BackColor="#e8f2fc" OnPageIndexChanging="gvCategoriaTitulo_PageIndexChanging" OnRowCommand="gvCategoriaTitulo_RowCommand">
                <Columns>
                  <asp:BoundField DataField="numero" HeaderStyle-Font-Size="Medium" />
                  <asp:BoundField DataField="nombre" HeaderStyle-Font-Size="Medium" HeaderStyle-HorizontalAlign="Center" HeaderText="CATEGORÍAS">
                    <ItemStyle Width="100%" />
                  </asp:BoundField>
                  <asp:TemplateField HeaderText="OPCIONES" HeaderStyle-Font-Size="Medium">
                    <ItemTemplate>
          ...
          <div class="card card-success">
            ...
            <div class="card-body" style="overflow-x: auto;">
              <asp:GridView ID="gvActividadTitulo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="idactividad_pat" OnRowDataBound="gvActividadTitulo_RowDataBound"
                CssClass="table table-bordered table-responsive dataTable" HeaderStyle-BackColor="#e8f2fc" OnPageIndexChanging="gvActividadTitulo_PageIndexChanging" OnRowCommand="gvActividadTitulo_RowCommand">
                <Columns>
                  <asp:BoundField DataField="idactividad_pat" HeaderStyle-Font-Size="Medium" />
                  <asp:BoundField DataField="nombre" HeaderStyle-Font-Size="Medium" HeaderText="ACTIVIDADES DEL PAT">
                    <ItemStyle Width="100%" />
                  </asp:BoundField>
                  <asp:TemplateField HeaderText="OPCIONES" HeaderStyle-Font-Size="Medium">
                    <ItemTemplate>
