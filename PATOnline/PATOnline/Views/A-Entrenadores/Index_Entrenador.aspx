<%@ Page Title="A-ENTRENADORES" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index_Entrenador.aspx.cs" Inherits="PATOnline.Views.A_Entrenadores.Index_Entrenador" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">A-Entrenadores</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearEntrenadorNew">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">ENTRENADOR</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoEntrenador" CausesValidation="false" OnClick="nuevoEntrenador_Click">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearEntrenador">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">CREAR NUEVO ENTRENADOR</span></h3>
            ...
            <div class="card-body pad" style="display: block;">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtCrearModalidadDeportiva" CssClass="control-label"><span style="color:red">*</span> MODALIDAD DEPORTIVA</asp:Label>
                  <input runat="server" id="txtCrearModalidadDeportiva" class="form-control" type="text" onkeypress="return letras(event)" placeholder="ingresar modalidad deportiva" maxlength="45" autofocus required />
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="txtCrearModalidadDeportiva"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una modalidad deportiva" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtCrearCategoriaEdad" CssClass="control-label"><span style="color:red">*</span> CATEGORÍA EDAD</asp:Label>
                  <input runat="server" id="txtCrearCategoriaEdad" class="form-control" type="text" placeholder="ingresar categoria de edad" maxlength="45" autofocus required />
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="txtCrearCategoriaEdad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una categoria de edad" />
                </div>
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="dropCrearResponsabilidad" CssClass="control-label"><span style="color:red">*</span> RESPONSABILIDAD</asp:Label>
                  <asp:DropDownList runat="server" ID="dropCrearResponsabilidad" CssClass="form-control"></asp:DropDownList>
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="dropCrearResponsabilidad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una responsabilidad" />
                </div>
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="dropCrearLinea" CssClass="control-label"><span style="color:red">*</span> LINEA QUE ATIENDE</asp:Label>
                  <asp:DropDownList runat="server" ID="dropCrearLinea" CssClass="form-control"></asp:DropDownList>
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="dropCrearLinea"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una linea" />
                </div>
              </div>
            </div>

            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearEntrenador" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearEntrenador_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarCrear" ID="crearEntrenador" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearEntrenador_Click">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditEntrenador">
            <div class="card-header">
            ...
            <div class="card-body pad" style="display: block;">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtEditModalidadDeportiva" CssClass="control-label"><span style="color:red">*</span> MODALIDAD DEPORTIVA</asp:Label>
                  <input runat="server" id="txtEditModalidadDeportiva" class="form-control" type="text" onkeypress="return letras(event)" placeholder="ingresar modalidad deportiva" maxlength="45" autofocus required />
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="txtEditModalidadDeportiva"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una modalidad deportiva" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtEditCategoriaEdad" CssClass="control-label"><span style="color:red">*</span> CATEGORÍA EDAD</asp:Label>
                  <input runat="server" id="txtEditCategoriaEdad" class="form-control" type="text" placeholder="ingresar categoria de edad" maxlength="45" autofocus required />
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="txtEditCategoriaEdad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una categoria de edad" />
                </div>
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="dropEditResponsabilidad" CssClass="control-label"><span style="color:red">*</span> RESPONSABILIDAD</asp:Label>
                  <asp:DropDownList runat="server" ID="dropEditResponsabilidad" CssClass="form-control"></asp:DropDownList>
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="dropEditResponsabilidad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una responsabilidad" />
                </div>
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="dropEditLinea" CssClass="control-label"><span style="color:red">*</span> LINEA QUE ATIENDE</asp:Label>
                  <asp:DropDownList runat="server" ID="dropEditLinea" CssClass="form-control"></asp:DropDownList>
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="dropEditLinea"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una linea" />
                </div>
              </div>
            </div>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditEntrenador" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditEntrenador_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarEdit" ID="editEntrenador" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editEntrenador_Click">
                <span class="fa fa-save"></span>
              </asp:LinkButton>
            </div>
          </div>
                ...
                <div class="col-md-12">
                  <asp:GridView ID="gridFADN" runat="server" AutoGenerateColumns="False" DataKeyNames="numero" OnRowDataBound="gridFADN_RowDataBound"
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="laboral" HeaderText="DEPARTAMENTO DONDE LABORA" />
                      <asp:BoundField DataField="modalidad" HeaderText="MODALIDAD DEPORTIVA QUE ATIENDE" />
                      <asp:BoundField DataField="responsanilidad" HeaderText="RESPONSABILIDAD" />
                      <asp:BoundField DataField="categoria" HeaderText="CATEGORÍA DE EDAD" />
                      <asp:BoundField DataField="linea" HeaderText="LÍNEAS QUE ATIENDE" />
