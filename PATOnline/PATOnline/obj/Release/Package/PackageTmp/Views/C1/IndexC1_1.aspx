    ...
    <div class="row">
      <table id="tableTitulo" class="footable gradiant" style="color: white;">
        <tr>
          ...
          <td style="width: 112px; text-align: center" rowspan="3"><b>CATEGORÍA</b></td>
        ...
        <tr>
          ...
          <td style="width: 128px; text-align: center;"><b>DEPARTAMENTO</b></td>
          <td style="width: 100px; text-align: center"><b>PAÍS</b></td>
      ...
      <asp:GridView ID="gvP2" runat="server" AllowPaging="false" AutoGenerateColumns="False" DataKeyNames="numero" ShowHeader="false"
        ...
        <Columns>
          ...
          <asp:BoundField DataField="categoria">
            <ItemStyle Width="104px" Font-Size="Smaller" />
          </asp:BoundField>
          ...
          <asp:BoundField DataField="registro">
            <ItemStyle Width="103px" Font-Size="Smaller" />
          </asp:BoundField>
          <asp:BoundField DataField="inicio_dia">
            <ItemStyle Width="44px" Font-Size="Smaller" />
          </asp:BoundField>
          <asp:BoundField DataField="inicio_mes">
            <ItemStyle Width="45px" Font-Size="Smaller" />
          </asp:BoundField>
          ...
          <asp:BoundField DataField="departamento">
            <ItemStyle Width="126px" Font-Size="Smaller" />
          </asp:BoundField>
          <asp:BoundField DataField="pais">
            <ItemStyle Width="79px" Font-Size="Smaller" />
          </asp:BoundField>
          <asp:BoundField DataField="lugar">
            <ItemStyle Width="115px" Font-Size="Smaller" />
          </asp:BoundField>
          <asp:TemplateField>
            <ItemStyle Width="147px" Font-Size="Smaller" />
            <ItemTemplate>
              <span>Q
