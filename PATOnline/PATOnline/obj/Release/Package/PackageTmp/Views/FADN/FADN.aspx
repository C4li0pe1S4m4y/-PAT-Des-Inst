  ...
  <div class="row">
    <h1>
      ...
      <% if (boton.BotonCrear(this.Session["Usuario"].ToString()) == true)
          { %>
      <a href="CreateFADN.aspx" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a>
      <% } %> 
    </h1>
  </div>
  ...
  <div id="demo" class="row collapse in panel panel-default">
    <div class="panel-body">
      <asp:GridView ID="gvListadoInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="id_fand" OnPageIndexChanging="gvListadoInfo_PageIndexChanging"
        ...
        <Columns>
          <asp:BoundField DataField="nombre" HeaderText="FEDERACIÓN" ItemStyle-HorizontalAlign="Center">
            <ItemStyle Width="20%" />
          </asp:BoundField>
          <asp:BoundField DataField="Direccion" HeaderText="UBICACIÓN" ItemStyle-HorizontalAlign="Center">
            <ItemStyle Width="27%" />
          </asp:BoundField>
          <asp:BoundField DataField="telefono" HeaderText="TÉLEFONO" ItemStyle-HorizontalAlign="Center">
            <ItemStyle Width="5%" />
          </asp:BoundField>
          <asp:BoundField DataField="correo_electronico" HeaderText="CORREO ELECTRÓNICO" ItemStyle-HorizontalAlign="Center">
            <ItemStyle Width="5%" />
          </asp:BoundField>
