<%@ Page Title="ORGANO DISCIPLINARIO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearOrgano.aspx.cs" Inherits="PATOnline.Views.DirigentesFADN.CrearOrgano" %>
        ...
        <div class="panel-body">
          <asp:GridView ID="gvListadoInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo_PageIndexChanging"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="periodo" HeaderText="Perido">
                <ItemStyle Width="10%" />
              </asp:BoundField>
              <asp:TemplateField>
                <ItemTemplate>
