...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">C3.2</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearC32New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">C3.2</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoC32" CausesValidation="false" OnClick="nuevoC32_Click">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearC32">
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearActividad"
                ...
                <div class="col-md-3">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearCategoria"
                ...
                <div class="col-md-2">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="txtCrearPresupuesto"
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="txtCrearEdades"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar las edades" />
                </div>
                <div class="col-md-3">
                  <asp:Label runat="server" AssociatedControlID="txtCrearMasculino" CssClass="control-label"><span style="color:red">*</span> MASCULINO</asp:Label>
                  <input runat="server" id="txtCrearMasculino" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus />
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="txtCrearMasculino"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una cantidad" />
                </div>
                <div class="col-md-3">
                  <asp:Label runat="server" AssociatedControlID="txtCrearFemenino" CssClass="control-label"><span style="color:red">*</span> FEMENINO</asp:Label>
                  <input runat="server" id="txtCrearFemenino" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus />
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="txtCrearFemenino"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una cantidad" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="txtCrearRegistro"
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearDiaInicio"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearMesInicio"
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearDiaFin"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un día" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearMesFin"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un mes" />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="dropCrearDepartamento"
                    ...
                    <div class="col-md-7">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC32" runat="server" ControlToValidate="txtCrearLugar"
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearC32" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearC32_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarCrearC32" ID="crearC32" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearC32_Click">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditC32">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">MODIFICAR C3.2</span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fa fa-minus"></i>
                </button>
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="dropEditActividad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una actividad" />
                </div>
                <div class="col-md-3">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="dropEditCategoria"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una categoria" />
                </div>
                <div class="col-md-2">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="txtEditPresupuesto"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un presupuesto" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="txtEditEdades"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar las edades" />
                </div>
                <div class="col-md-3">
                  <asp:Label runat="server" AssociatedControlID="txtEditMasculino" CssClass="control-label"><span style="color:red">*</span> MASCULINO</asp:Label>
                  <input runat="server" id="txtEditMasculino" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus />
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="txtEditMasculino"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una cantidad" />
                </div>
                <div class="col-md-3">
                  <asp:Label runat="server" AssociatedControlID="txtEditFemenino" CssClass="control-label"><span style="color:red">*</span> FEMENINO</asp:Label>
                  <input runat="server" id="txtEditFemenino" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus />
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="txtEditFemenino"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar una cantidad" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="txtEditRegistro"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un registro" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="dropEditDiaInicio"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un día" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="dropEditMesInicio"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un mes" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="dropEditDiaFin"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un día" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC32" runat="server" ControlToValidate="dropEditMesFin"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un mes" />
                    </div>
                  </div>
                </div>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditC32" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditC32_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarEditC31" ID="editC32" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editC32_Click">
                <span class="fa fa-save"></span>
              </asp:LinkButton>
            </div>
          </div>
                    ...
                    <div class="col-md-12">
                      <asp:GridView ID="gridFADN" runat="server" AutoGenerateColumns="False" DataKeyNames="numero" OnRowDataBound="gridFADN_RowDataBound"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="actividad" ItemStyle-Width="87px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="edades" ItemStyle-Width="98px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="mas" ItemStyle-Width="48px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="fem" ItemStyle-Width="48px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="total" ItemStyle-Width="48px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="registro" ItemStyle-Width="58px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="inicio_dia" ItemStyle-Width="49px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="inicio_mes" ItemStyle-Width="49px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="fin_dia" ItemStyle-Width="48px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="fin_mes" ItemStyle-Width="48px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="departamento" ItemStyle-Width="137px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="lugar" ItemStyle-Width="125px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="presupuesto" ItemStyle-Width="140px" ItemStyle-HorizontalAlign="Center" SortExpression="presupuesto" DataFormatString="{0:c}" ItemStyle-Font-Size="Small" />
