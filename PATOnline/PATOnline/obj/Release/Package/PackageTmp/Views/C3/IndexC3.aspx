<%@ Page Title="3. NIVEL COMPETITIVO NACIONAL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IndexC3.aspx.cs" Inherits="PATOnline.Views.C3.IndexC3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <section class="content" runat="server" id="crearC3New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            ...
            <asp:LinkButton runat="server" ID="nuevoC3" CausesValidation="false" OnClick="nuevoC3_Click">
      ...
      <section class="content">
        <div class="container-fluid">
        <asp:UpdatePanel runat="server" ID="updateCrearC3">
        <ContentTemplate>
          <div class="row">
            <div class="col-md-6">
              <div class="card card-outline card-info" runat="server" id="mostrarCrearC3">
                <div class="card-header">
                  <h3 class="card-title"><span class="info-box-number">CREAR NUEVO C3</span></h3>
                ...
                <div class="card-body pad" style="display: block;">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC3" runat="server" ControlToValidate="dropCrearFormato"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC3" runat="server" ControlToValidate="txtCrearEneroAbril"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC3" runat="server" ControlToValidate="txtCrearMayoAgosto"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC3" runat="server" ControlToValidate="txtCrearSeptiembreDiciembre"
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarCrearC3" runat="server" ControlToValidate="txtCrearPresupuesto"
                ...
                <div class="card-footer">
                  <asp:LinkButton runat="server" ID="cancelCrearC3" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearC3_Click">
                <span class="fa fa-close"></span>
                  </asp:LinkButton>
                  <asp:LinkButton runat="server" ValidationGroup="validarCrearC3" ID="crearC3" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearC3_Click">
            ...
            <div class="col-md-6">
              <div class="card card-outline card-warning" runat="server" id="mostrarEditC3">
                <div class="card-header">
                  <h3 class="card-title"><span class="info-box-number">MODIFICAR C3</span></h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                      <i class="fa fa-minus"></i>
                    </button>
                ...
                <div class="card-body pad" style="display: block;">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC3" runat="server" ControlToValidate="dropEditFormato"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un Formato" />
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC3" runat="server" ControlToValidate="txtEditEneroAbril"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC3" runat="server" ControlToValidate="txtEditMayoAgosto"
                        CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un valor o 0" />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC3" runat="server" ControlToValidate="txtEditSeptiembreDiciembre"
                        CssClass="text-danger" ErrorMessage="* El es obligatorio ingresar un valor o 0" />
                    </div>
                    <div class="col-md-6">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="validarEditC3" runat="server" ControlToValidate="txtEditPresupuesto"
                        CssClass="text-danger" ErrorMessage="* El Presupuesto es obligatorio" />
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <asp:LinkButton runat="server" ID="cancelEditC3" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditC3_Click">
                <span class="fa fa-close"></span>
                  </asp:LinkButton>
                  <asp:LinkButton runat="server" ValidationGroup="validarEditC3" ID="editC3" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editC3_Click">
                <span class="fa fa-save"></span>
                  </asp:LinkButton>
                </div>
              </div>
                ...
                <div class="card-body" style="overflow-x: auto;">
                  ...
                  <div class="row" style="text-align: center;">
                    <div class="col-md-12" style="background-color: darkturquoise; color: black;">
                      <h4>
                        <asp:Label runat="server" ForeColor="Black" Text="3. NIVEL COMPETITIVO NACIONAL"></asp:Label></h4>
                    </div>
