<%@ Page Title="ANALISIS SOBRE PUESTOS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearPuesto.aspx.cs" Inherits="PATOnline.Views.LogroBrecha.CrearPuesto" %>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <asp:TextBox runat="server" ID="TxtObservacionPuesto" CssClass="form-control" TextMode="MultiLine" />
            </div>
          </div>
        </div>
