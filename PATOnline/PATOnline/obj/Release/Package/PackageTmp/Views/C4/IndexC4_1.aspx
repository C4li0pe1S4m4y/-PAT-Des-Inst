...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">C4.1</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearC41New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">C4.1</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoC41" CausesValidation="false" OnClick="nuevoC41_Click">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearC41">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">CREAR NUEVO C4.1</span></h3>
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="dropCrearActividad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una actividad" />
                </div>
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtCrearObjetivo" CssClass="control-label"><span style="color:red">*</span> OBJETIVO</asp:Label>
                  <textarea runat="server" id="txtCrearObjetivo" class="form-control" type="text" onkeypress="return descripcion(event)" placeholder="ingresar el objetivo" maxlength="125" autofocus required></textarea>
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="txtCrearObjetivo"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio el objetivo" />
                </div>
                <div class="col-md-2">
              ...
              <div class="row">
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="dropCrearEtapa" CssClass="control-label">ETAPA DE PREPARACIÓN</asp:Label>
                  <asp:DropDownList runat="server" ID="dropCrearEtapa" CssClass="form-control"></asp:DropDownList>
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="dropCrearEtapa"
              ...
              <div class="row">
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="txtCrearDirigido" CssClass="control-label"><span style="color:red">*</span> DIRIGIDO A:</asp:Label>
                  <textarea runat="server" id="txtCrearDirigido" class="form-control" type="text" onkeypress="return descripcion(event)" placeholder="dirigido a" maxlength="125" autofocus required></textarea>
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="txtCrearDirigido"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio dirigir la informacion" />
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="dropCrearDepartamento"
                            CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un país" />
                        </div>
                        <div class="col-md-5">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="txtCrearDescripcion"
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearC41" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearC41_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarCrear" ID="crearC41" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearC41_Click">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditC41">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">MODIFICAR C4.1</span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fa fa-minus"></i>
                </button>
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="dropEditActividad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar una actividad" />
                </div>
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtEditObjetivo" CssClass="control-label"><span style="color:red">*</span> OBJETIVO</asp:Label>
                  <textarea runat="server" id="txtEditObjetivo" class="form-control" type="text" onkeypress="return descripcion(event)" placeholder="ingresar el objetivo" maxlength="125" autofocus required></textarea>
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="txtEditObjetivo"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio el objetivo" />
                </div>
                <div class="col-md-2">
              ...
              <div class="row">
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="dropEditEtapa" CssClass="control-label">ETAPA DE PREPARACIÓN</asp:Label>
                  <asp:DropDownList runat="server" ID="dropEditEtapa" CssClass="form-control"></asp:DropDownList>
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="dropEditEtapa"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un objetivo" />
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="txtEditDirigido" CssClass="control-label"><span style="color:red">*</span> DIRIGIDO A:</asp:Label>
                  <textarea runat="server" id="txtEditDirigido" class="form-control" type="text" onkeypress="return descripcion(event)" placeholder="dirigido a" maxlength="125" autofocus required></textarea>
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="txtEditDirigido"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio dirigir la informacion" />
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="dropEditDepartamento"
                            CssClass="text-danger" ErrorMessage="* Es obligatorio seleccionar un país" />
                        </div>
                        <div class="col-md-5">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="txtEditDescripcion"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio ingresar un descripcion" />
                </div>
              </div>
            </div>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditC41" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditC41_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarEdit" ID="editC41" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editC41_Click">
                <span class="fa fa-save"></span>
              </asp:LinkButton>
            </div>
          </div>
                    ...
                    <div class="col-md-12">
                      <asp:GridView ID="gridFADN" runat="server" AutoGenerateColumns="False" DataKeyNames="numero" OnRowDataBound="gridFADN_RowDataBound"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="actividad" ItemStyle-Width="63px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="descripcion" ItemStyle-Width="78px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="objetivo" ItemStyle-Width="62px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="etapa" ItemStyle-Width="76px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="dirigido" ItemStyle-Width="65px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="linea" ItemStyle-Width="73px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="categoria" ItemStyle-Width="70px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="registro" ItemStyle-Width="66px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="inicio_dia" ItemStyle-Width="38px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          ...
                          <asp:BoundField DataField="pais" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="departamento" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="lugar" ItemStyle-Width="90px" ItemStyle-Font-Size="X-Small" />
