...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">C4.2</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearC42New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            <div class="info-box-content">
              ...
              <span class="info-box-number">C4.2</span>
            </div>
            <asp:LinkButton runat="server" ID="nuevoC42" CausesValidation="false" OnClick="nuevoC42_Click">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearC42">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">CREAR NUEVO C4.2</span></h3>
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                ...
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtCrearActividad" CssClass="control-label"><span style="color:red">*</span> NOMBRE DE LA ACTIVIDAD</asp:Label>
                  <input runat="server" id="txtCrearActividad" class="form-control" type="text" onkeypress="return descripcion(event)" placeholder="ingresar el nombre de la actividad" maxlength="125" autofocus required />
                  <asp:RequiredFieldValidator ValidationGroup="validarCrear" runat="server" ControlToValidate="txtCrearActividad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio el nombre de la actividad" />
                </div>
                <div class="col-md-4">
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearC42" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearC42_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarCrear" ID="crearC42" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearC42_Click">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditC42">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">MODIFICAR C4.2</span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fa fa-minus"></i>
                </button>
            ...
            <div class="card-body pad" style="display: block;">
              <div class="row">
                ...
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="txtEditActividad" CssClass="control-label"><span style="color:red">*</span> NOMBRE DE LA ACTIVIDAD</asp:Label>
                  <input runat="server" id="txtEditActividad" class="form-control" type="text" onkeypress="return descripcion(event)" placeholder="ingresar el nombre de la actividad" maxlength="125" autofocus required />
                  <asp:RequiredFieldValidator ValidationGroup="validarEdit" runat="server" ControlToValidate="txtEditActividad"
                    CssClass="text-danger" ErrorMessage="* Es obligatorio el nombre de la actividad" />
                </div>
                <div class="col-md-4">
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditC42" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditC42_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarEdit" ID="editC42" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editC42_Click">
                <span class="fa fa-save"></span>
              </asp:LinkButton>
            </div>
          </div>
                    ...
                    <div class="col-md-12">
                      <asp:GridView ID="gridFADN" runat="server" AutoGenerateColumns="False" DataKeyNames="numero" OnRowDataBound="gridFADN_RowDataBound"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="codigo" ItemStyle-Width="57px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="actividad" ItemStyle-Width="" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="nivel" ItemStyle-Width="78px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="objetivo" ItemStyle-Width="75px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="etapa" ItemStyle-Width="73px" ItemStyle-Font-Size="X-Small" />
                          <asp:BoundField DataField="categoria" ItemStyle-Width="82px" ItemStyle-Font-Size="X-Small" />
                          ...
                          <asp:BoundField DataField="departamento" ItemStyle-Width="87px" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="X-Small" />
