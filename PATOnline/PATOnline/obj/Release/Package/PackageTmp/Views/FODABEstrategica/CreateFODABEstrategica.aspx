<%@ Page Title="FODA - BASE ESTRATÉGICA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateFODABEstrategica.aspx.cs" Inherits="PATOnline.Views.FODABEstrategica.CreateFODABEstrategica" %>
    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <asp:TextBox runat="server" ID="TxtFortaleza" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <asp:TextBox runat="server" ID="TxtOportunidad" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <asp:TextBox runat="server" ID="TxtDebilidad" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <asp:TextBox runat="server" ID="TxtAmenaza" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <asp:TextBox runat="server" ID="TxtValor" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
