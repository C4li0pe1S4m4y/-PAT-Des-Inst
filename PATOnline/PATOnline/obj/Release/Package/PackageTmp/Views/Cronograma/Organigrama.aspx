  ...
  <div class="row">
    <h1>ORGANIGRAMA INSTITUCIONAL
      ...
      <% if (boton.BotonCrear(this.Session["Usuario"].ToString()) == true)
          { %>
      <a data-toggle="modal" data-target="#Mostrar" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a>
      <% } %> 
    </h1>
  </div>
  <!--ShowModel Ver-->
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <asp:RegularExpressionValidator ID="REGEXFileUploadLogo" runat="server" ValidationGroup="validar"
          ...
          <div class="modal-footer gradiant-inver">
            <asp:LinkButton runat="server" ID="Save" ValidationGroup="validar" type="button" class="btn btn-save" data-toggle="tooltip" data-placement="bottom" title="¡Guardar!" OnClick="Save_Click">
                                <span class="glyphicon glyphicon-floppy-disk"></span>
            </asp:LinkButton>
            <asp:LinkButton runat="server" ID="Cancel" CausesValidation="false" type="button" class="btn btn-cancel" data-toggle="tooltip" data-placement="bottom" title="¡Cancelar!" OnClick="Cancel_Click">
    ...
    <div id="demo" class="row collapse in panel panel-default">
      <div class="panel-body">
        <asp:GridView ID="gvOrganigrama" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvOrganigrama_PageIndexChanging" 
          HeaderStyle-ForeColor="Black" Width="100%" PagerStyle-ForeColor="Black" ForeColor="Black" OnRowCommand="gvOrganigrama_RowCommand" GridLines="None" AllowSorting="True">
          <Columns>
