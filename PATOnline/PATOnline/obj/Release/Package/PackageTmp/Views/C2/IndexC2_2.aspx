<%@ Page Title="C2.2: PROGRAMAS DE APOYO A DEPORTISTAS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IndexC2_2.aspx.cs" Inherits="PATOnline.Views.C2.IndexC2_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">C2.2</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content" runat="server" id="crearC22New">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <div class="info-box">
            ...
            <asp:LinkButton runat="server" ID="nuevoC22" CausesValidation="false" OnClick="nuevoC22_Click">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info" runat="server" id="mostrarCrearC22">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">CREAR NUEVO C2.2</span></h3>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelCrearC22" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelCrearC22_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarCrearC" ID="crearC22" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="crearC22_Click">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-warning" runat="server" id="mostrarEditC22">
            <div class="card-header">
              <h3 class="card-title"><span class="info-box-number">MODIFICAR C2.2</span></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fa fa-minus"></i>
                </button>
            ...
            <div class="card-footer">
              <asp:LinkButton runat="server" ID="cancelEditC22" type="button" class="btn btn-info btn-outline-danger btn-lg" CausesValidation="false" OnClick="cancelEditC22_Click">
                <span class="fa fa-close"></span>
              </asp:LinkButton>
              <asp:LinkButton runat="server" ValidationGroup="validarEditC" ID="editC22" type="button" class="btn btn-info btn-outline-primary btn-lg float-right" OnClick="editC22_Click">
                <span class="fa fa-save"></span>
              </asp:LinkButton>
            </div>
          </div>
