                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <asp:Label runat="server" AssociatedControlID="checkBoton" CssClass="control-label">BOTÓN</asp:Label>
                            <asp:CheckBoxList runat="server" ID="checkBoton" DataTextField="boton"
                              DataValueField="numero" CssClass="form-check" CausesValidation="false" CellPadding="4"
                              CellSpacing="4" RepeatColumns="5" RepeatDirection="Vertical">
                            </asp:CheckBoxList>
                          </div>
                          <br />
                          <div style="text-align: center">
