<%@ Page Title="ROL - PERMISO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateRolPermiso.aspx.cs" Inherits="PATOnline.Views.RolPermiso.CreateRolPermiso" %>
  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      ...
      <ul class="nav nav-tabs faq-cat-tabs">
        ...
        <li><a href="#faq-cat-2" data-toggle="tab">MENU</a></li>
        <li><a href="#faq-cat-3" data-toggle="tab">ACCION</a></li>
              ...
              <div id="faq-cat-1-sub-1" class="row collapse in panel panel-default">
                <div class="panel-body">
                  <asp:GridView ID="gvListRol" runat="server" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListRol_PageIndexChanging" PageSize="5"
                    ...
                    <Columns>
                      <asp:BoundField DataField="numero" HeaderText="No." Visible="false">
                        <ItemStyle Width="1%" />
                      </asp:BoundField>
            ...
            <div class="panel panel-default panel-faq">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12">
                      <asp:Label runat="server" AssociatedControlID="TxtMenu" CssClass="control-label">Menu</asp:Label>
                ...
                <div class="panel-body">
                  <asp:GridView ID="gvListMenu" runat="server" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListMenu_PageIndexChanging" PageSize="5"
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="menu" HeaderText="Nombre Menu" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                    </Columns>
                  </asp:GridView>
                </div>
              </div>
            ...
            <div class="panel panel-default panel-faq">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12">
                      <asp:Label runat="server" AssociatedControlID="TxtBoton" CssClass="control-label">Boton</asp:Label>
                ...
                <div class="panel-body">
                  <asp:GridView ID="gvListBoton" runat="server" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListBoton_PageIndexChanging" PageSize="5"
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="boton" HeaderText="Nombre Boton" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                    </Columns>
                  </asp:GridView>
                </div>
              </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <asp:Label runat="server" AssociatedControlID="DropBoton" CssClass="control-label">Boton</asp:Label>
                  ...
                  <div id="faq-cat-4-sub-1" class="row collapse in panel panel-default">
                    <div class="panel-body">
                      <asp:GridView ID="gvListPermiso" runat="server" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo_PageIndexChanging" PageSize="4"
                        CssClass="footable" AllowCustomPaging="False" OnRowCommand="gvListadoInfo_RowCommand1" GridLines="None" HorizontalAlign="Center" AllowSorting="True">
