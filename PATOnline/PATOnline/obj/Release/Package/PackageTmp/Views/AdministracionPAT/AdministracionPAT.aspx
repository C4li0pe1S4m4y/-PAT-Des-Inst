          ...
          <div class="panel-group" id="accordion-cat-1">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-7 col-md-offset-4">
                      ...
                      <input runat="server" id="TxtBrecha" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre de brecha" maxlength="40" autofocus required />
            ...
            <div class="panel panel-default panel-faq">
              ...
              <div id="faq-cat-1-sub-1" class="row collapse in panel panel-default">
                <div class="containere panel-body">
                  <asp:GridView ID="gvListBrecha" runat="server" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="numero" PageSize="5" OnPageIndexChanging="gvListBrecha_PageIndexChanging"
                    CssClass="footable" HeaderStyle-ForeColor="Black" PagerStyle-ForeColor="Black" ForeColor="Black" GridLines="None" AllowSorting="True" Font-Size="Larger">
                    <Columns>
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-7 col-md-offset-4">
                      ...
                      <input runat="server" id="TxtCargo" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre del cargo" maxlength="40" autofocus required />
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-7 col-md-offset-4">
                      <asp:Label runat="server" CssClass="control-label">NOMBRE</asp:Label>
                      <input runat="server" id="TxtCategoria" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre de la categoria" maxlength="40" autofocus required />
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-md-7 col-md-offset-4">
                      <asp:Label runat="server" CssClass="control-label">NOMBRE</asp:Label>
                      <input runat="server" id="TxtNivel" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre del nivel" maxlength="40" autofocus required />
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-7 col-md-offset-4">
                      <asp:Label runat="server" CssClass="control-label">NOMBRE</asp:Label>
                      <input runat="server" id="TxtTipoPersonal" class="form-control" type="text" onkeypress="return letras(event)" minlength="4" placeholder="nombre del personal" maxlength="40" autofocus required />
