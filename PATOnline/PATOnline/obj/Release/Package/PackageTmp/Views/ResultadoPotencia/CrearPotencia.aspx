<%@ Page Title="ANÁLISIS DE PRINCIPALES POTENCIAS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearPotencia.aspx.cs" Inherits="PATOnline.Views.ResultadoPotencia.CrearPotencia" %>
  ...
  <div class="row">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <asp:Label runat="server" AssociatedControlID="TxtPosicion" CssClass="control-label">Posicion Guatemala</asp:Label>
