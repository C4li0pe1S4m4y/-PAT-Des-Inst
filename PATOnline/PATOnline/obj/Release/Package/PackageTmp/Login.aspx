        ...
        <div class="page-container">            
            <form id="form1" runat="server">
              ...
              <div class="row">
                ...
                <asp:TextBox runat="server" CssClass="username" ID="TxtUser" placeholder="Usuario"></asp:TextBox>
                <div class="row">
                ...
                <asp:TextBox runat="server" CssClass="password" ID="TxtPass" placeholder="Password" TextMode="Password"></asp:TextBox>
                <div class="row">
