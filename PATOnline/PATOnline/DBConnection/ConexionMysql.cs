...
namespace PATOnline.DBConnection
{
    ...
    {
        private String contenido = "server=localhost;user=root;database=dbcdagpat;password=root";
        private String contenido1 = "server=localhost; database =dbcdagpat;user=usr_cdag_sipa; password =5sr_cd1g_s3pa";
