...
{
    public class SearchC4_3
    {
        public string query = "";
        public int codigo;
        public double presupuesto;
        public int CodigoC4_3(string fadn, string ano)
        {
        ...
        public bool ExisteCodigoC4_3(string codigo, string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
        ...
        public double PresupuestoC4_3(string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
            mysql.AbrirConexion();
            ...
            "AND f.nombre = 'C4.3 Alcance Competitivo Nacional';", fadn, ano);
            MySqlCommand cmd = new MySqlCommand(query, mysql.conectar);
            MySqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
