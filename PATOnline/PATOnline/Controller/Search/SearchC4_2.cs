...
{
    public class SearchC4_2
    {
        public string query = "";
        public int codigo;
        public double presupuesto;
        public int CodigoC4_2(string fadn, string ano)
        {
        ...
        public bool ExisteCodigoC4_2(string codigo, string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
        ...
        public double PresupuestoC4_2(string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
            mysql.AbrirConexion();
            ...
            "AND f.nombre = 'C4.2 Campamentos de Preparación';", fadn, ano);
            MySqlCommand cmd = new MySqlCommand(query, mysql.conectar);
            MySqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
