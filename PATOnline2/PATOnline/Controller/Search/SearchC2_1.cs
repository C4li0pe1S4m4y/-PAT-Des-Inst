...
{
    public class SearchC2_1
    {
        public string query = "";
        public int codigo;
        public double presupuesto;
        public int CodigoC2_1(string fadn, string ano)
        {
        ...
        public bool ExisteCodigoC2_1(string codigo, string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
        ...
        public double PresupuestoC2_1(string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
            mysql.AbrirConexion();
            ...
            "AND f.nombre = 'C2.1 Actividad de Fortalecimiento al Deporte Federado';", fadn, ano);
            MySqlCommand cmd = new MySqlCommand(query, mysql.conectar);
            MySqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
