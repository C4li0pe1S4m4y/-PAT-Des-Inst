...
{
    public class SearchC3_2
    {
        public string query = "";
        public int codigo;
        public double presupuesto;
        public int CodigoC3_2(string fadn, string ano)
        {
        ...
        public bool ExisteCodigoC3_2(string codigo, string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
        ...
        public double PresupuestoC3_2(string fadn, string ano)
        {
            var mysql = new DBConnection.ConexionMysql();
            mysql.AbrirConexion();
            ...
            "AND f.nombre = 'C3.2 Sistema de Juegos Deportivos Nacionales';", fadn, ano);
            MySqlCommand cmd = new MySqlCommand(query, mysql.conectar);
            MySqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
