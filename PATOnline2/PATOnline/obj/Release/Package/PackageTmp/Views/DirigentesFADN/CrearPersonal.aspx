<%@ Page Title="DIRIGENCIA DEPORITVA - PERSONAL TÉCNICO ADMINISTRATIVO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearPersonal.aspx.cs" Inherits="PATOnline.Views.DirigentesFADN.CrearPersonal" %>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtPeriodo" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="ingresar numero" maxlength="2" autofocus required />
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtNombre1" class="form-control" type="text" onkeypress="return letras(event)" placeholder="ingresar primer nombre" maxlength="25" autofocus required />
          ...
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtNombre2" class="form-control" type="text" onkeypress="return letras(event)" placeholder="ingresar segundo nombre" maxlength="25" autofocus required />
          </div>
          <div class="col-md-3">
            <asp:Label runat="server" AssociatedControlID="TxtApellido1" CssClass="control-label">PRIMER APELLIDO</asp:Label>
            <input runat="server" id="TxtApellido1" class="form-control" type="text" onkeypress="return letras(event)" placeholder="ingresar primer apellido" maxlength="25" autofocus required />
          ...
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtApellido2" class="form-control" type="text" onkeypress="return letras(event)" placeholder="ingresar segundo apellido" maxlength="25" autofocus required />
          </div>
        </div>
    ...
    <div id="demo" class="row collapse in panel panel-default">
      <div class="panel-body">
        <asp:GridView ID="gvListadoInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo_PageIndexChanging"
          CssClass="footable" HeaderStyle-ForeColor="Black" PagerStyle-ForeColor="Black" ForeColor="Black" GridLines="None" OnRowCommand="gvListadoInfo_RowCommand" Font-Size="Large">
          <Columns>
