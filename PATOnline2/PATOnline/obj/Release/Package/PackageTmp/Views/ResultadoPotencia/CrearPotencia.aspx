        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <input runat="server" id="TxtPotencia1" class="form-control" type="text" onkeypress="return letrasycomapunto(event)" placeholder="potencia" maxlength="50" autofocus required />
            ...
            <div class="col-md-3">
              ...
              <input runat="server" id="TxtPotencia2" class="form-control" type="text" onkeypress="return letrasycomapunto(event)" placeholder="potencia" maxlength="50" autofocus required />
            ...
            <div class="col-md-3">
              ...
              <input runat="server" id="TxtPotencia3" class="form-control" type="text" onkeypress="return letrasycomapunto(event)" placeholder="potencia" maxlength="50" autofocus required />
            ...
            <div class="col-md-3">
              ...
              <input runat="server" id="TxtPosicion" class="form-control" type="text" onkeypress="return letrasycomapunto(event)" placeholder="potencia" maxlength="50" autofocus required />
