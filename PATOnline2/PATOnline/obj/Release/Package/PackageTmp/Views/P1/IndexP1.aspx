...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <div class="row"  runat="server" id="divCrear">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header gradiant">
              ...
              <div class="row col-sm-offset-1">
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="TxtColUno" CssClass="control-label">MONTO COLUMNA NO. 1</asp:Label>
                   <input runat="server" id="TxtColUno" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
                ...
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="TxtColDos" CssClass="control-label">MONTO COLUMNA NO. 2</asp:Label>
                   <input runat="server" id="TxtColDos" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
                ...
                <div class="col-md-4">
                  <asp:Label runat="server" AssociatedControlID="TxtColTres" CssClass="control-label">MONTO COLUMNA NO. 3</asp:Label>
                   <input runat="server" id="TxtColTres" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
    ...
    <div class="row">
      <div class="containere">
        <asp:LinkButton ID="peque" runat="server" BackColor="InfoText" CssClass="btn btn-default" Width="100%" OnClick="peque_Click"><span style="width: 50%;" class="glyphicon glyphicon-zoom-out"></span></asp:LinkButton>
        <asp:LinkButton ID="grande" runat="server" BackColor="Info" CssClass="btn btn-default" Width="100%" OnClick="grande_Click"><span style="width: 50%;" class="glyphicon glyphicon-zoom-in"></span></asp:LinkButton>
      </div>
    </div>
    <br />
    <div class="row">
      <div class="containere" style="height: 250px; overflow-y: auto" runat="server" id="divInfo">
        <asp:GridView Width="1000%" runat="server" ID="gvP1" AutoGenerateColumns="False" DataKeyNames="idnumero1" OnRowDataBound="gvP1_RowDataBound" GridLines="None">
          <Columns>
            <asp:TemplateField>
              <ItemTemplate>
                <asp:GridView ID="gvP2" Width="1000%" runat="server" AllowPaging="false" AutoGenerateColumns="False" DataKeyNames="idnumero2" ShowHeader="false"
      ...
      <div class="containere" runat="server" id="divInfo2">
        <asp:GridView ID="gvP3" runat="server" AllowPaging="false" AutoGenerateColumns="False" DataKeyNames="idnumero2" BorderWidth="2" BorderColor="Black"
          ...
          <Columns>
            ...
            <asp:BoundField DataField="total1" SortExpression="total1" DataFormatString="{0:c}">
              <ItemStyle Width="154px" />
            </asp:BoundField>
            <asp:BoundField DataField="total2" SortExpression="total2" DataFormatString="{0:c}">
              <ItemStyle Width="152px" />
            </asp:BoundField>
            <asp:BoundField DataField="total3" SortExpression="total3" DataFormatString="{0:c}">
              ...
              <div class="row">
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="TxtCodigo" CssClass="control-label">CÓDIGO</asp:Label>
                   <input runat="server" id="TxtCodigo" class="form-control" type="text" onkeypress="return numerosypuntomenos(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
                ...
                <div class="col-md-6">
                  <asp:Label runat="server" AssociatedControlID="TxtNombre" CssClass="control-label">NOMBRE</asp:Label>
                   <input runat="server" id="TxtNombre" class="form-control" type="text" onkeypress="return numerosypuntomenos(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
