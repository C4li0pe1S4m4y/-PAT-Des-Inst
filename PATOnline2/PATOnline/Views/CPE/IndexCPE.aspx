...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtEA" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus required/>
          ...
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtMA" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus required/>
          ...
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtSD" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="000" maxlength="3" autofocus required/>
          ...
          <div class="col-md-3">
            ...
            <input runat="server" id="TxtPresupuesto" class="form-control" type="text" onkeypress="return numeros(event)" placeholder="0,000,000.00" maxlength="12" autofocus required/>
  ...
  <div class="row">
    <div class="row" style="align-content: center; text-align: center; border: solid; background-color: aquamarine; color: black;">
      <h3>
        <asp:Label runat="server" ForeColor="Black" Text="PLANIFICACIÓN ESTRATÉGICA Y GESTIÓN ADMINISTRATIVA DE LA ALTA DIRECCIÓN"></asp:Label>
      </h3>
    </div>
    <br />
    ...
    <div class="row">
      <table id="tableTitulo" class="table-bordered gradiant" style="color: white; width: 100%">
        <tr>
          ...
          <td style="width: 402px; text-align: center" rowspan="2"><b>FORMATO "C"</b></td>
          <td style="text-align: center" colspan="4"><b>ACTIVIDADES</b></td>
          <td style="width: 205px; text-align: center" rowspan="2"><b>PRESUPUESTO</b></td>
        </tr>
        <tr>
          <td style="width: 100px; text-align: center"><b>ENE-ABR</b></td>
          <td style="width: 100px; text-align: center"><b>MAY-AGO</b></td>
          <td style="width: 100px; text-align: center"><b>SEP-DIC</b></td>
          <td style="width: 100px; text-align: center"><b>ANUAL</b></td>
        </tr>
      </table>
    </div>
    <div class="row">
