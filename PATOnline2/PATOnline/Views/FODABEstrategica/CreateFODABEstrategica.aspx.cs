...
namespace PATOnline.Views.FODABEstrategica
{
    public partial class CreateFODABEstrategica : System.Web.UI.Page
    {
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            modelo.fortaleza = TxtFortaleza.Value;
            modelo.oportunidad = TxtOportunidad.Value;
            modelo.debilidad = TxtDebilidad.Value;
            modelo.amenaza = TxtAmenaza.Value;

            modelo.vision = TxtVision.Value;
            modelo.mision = TxtMision.Value;
            modelo.valor = TxtValor.Value;
