    ...
    public partial class CreateRolPermiso : System.Web.UI.Page
    {
        ...
        protected void SaveRol_Click(object sender, EventArgs e)
        {
            if (TxtRol.Value != "")
            {
                ...
                if (buscar_rol.ExisteRol(TxtRol.Value) == true)
                {
                }
                else
                {
        ...
        protected void SaveMenu_Click(object sender, EventArgs e)
        {
            if (TxtMenu.Value != "")
            {
                modelo_menu.nombre = TxtMenu.Value;
                if (buscar_menu.ExisteMenu(TxtMenu.Value) == true)
                {
                }
                else
                {
        ...
        protected void SaveBoton_Click(object sender, EventArgs e)
        {
            if (TxtBoton.Value != "")
            {
                modelo_boton.nombre = TxtBoton.Value;
                if (buscar_menu.ExisteMenu(TxtBoton.Value) == true)
                {
                }
                else
                {
        ...
        public void Pintar_Check(int id_rol, int id_menu)
        {
            ...
            foreach (ListItem item in checkboxTwoInput.Items)
            {
