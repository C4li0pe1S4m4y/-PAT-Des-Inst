    ...
    public partial class IndexC1_1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                drop.Drop_Categoria(DropCategoria, 2);
        ...
        protected void SaveIngreso_Click(object sender, EventArgs e)
        {
            ...
            modelo.categoria = int.Parse(DropCategoria.SelectedValue);
            ...
            try
            {
                if(ultimo_codigo.ExisteCodigoC1_1(TxtCodigo.Text, federacion, ano) != true)
                {
        ...
        protected void gvP3_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (double.Parse((e.Row.FindControl("lblPresupuesto") as Label).Text) == ultimo_codigo.PresupuestoC1_1(federacion, ano))
                {
