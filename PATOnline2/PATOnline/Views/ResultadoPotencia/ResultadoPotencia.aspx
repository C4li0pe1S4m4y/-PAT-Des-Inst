    ...
    <div class="row" style="text-align: center; align-content: center;">
      <div class="col-md-5">
        <h4>
          ...
          <a href="CrearResultado.aspx" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a></h4>
      </div>
      <div class="col-md-7">
        <h4>
          <asp:Label runat="server" ID="lblPotencia"></asp:Label>
          <a href="CrearPotencia.aspx" data-placement="bottom" title="¡Crear Nuevo!"><span class="glyphicon glyphicon-plus-sign"></span></a></h4>
      </div>
    </div>
    <% } %>
  </div>
    ...
    <div id="demo2" class="row collapse in panel panel-default">
      ...
      <div class="panel-body">
        <asp:GridView ID="gvListadoInfo2" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="numero" OnPageIndexChanging="gvListadoInfo2_PageIndexChanging"
          CssClass="footable" HeaderStyle-ForeColor="Black" PagerStyle-ForeColor="Black" ForeColor="Black" GridLines="None" OnRowCommand="gvListadoInfo2_RowCommand" Font-Size="Large">
          <Columns>
            <asp:BoundField DataField="nivel" HeaderText="NIVEL">
              <ItemStyle Width="5%" />
            </asp:BoundField>
